...
(function () {
    ...
    yardi.extend(rateItems, yardi.baseField, {
        ...
        buildHtml: function () {
            ...
            yardi.baseSnippets.fieldCommon(html, this, 'Rate Items on a Scale');
            html.push('<table cellpadding="0" cellspacing="0" border="0">');
            html.push('<tr>');
            html.push('<th class="attrs">&nbsp;</th>');
            this.itemCount++;
            html.push('<th #{sync}="' + this.itemCount + '" class="center custext">Least</th>');
            this.itemCount++;
            html.push('<th #{sync}="' + this.itemCount + '" class="center custext">Medium</th>');
            this.itemCount++;
            html.push('<th #{sync}="' + this.itemCount + '" class="center custext">Most</th>');
            html.push('</tr>');
            html.push('<tr>');
            this.itemCount++;
            html.push('<td #{sync}="' + this.itemCount + '" empty="false" class="attrs custext">Attribute1</td>');
            radioName = this.groupInputName();
            html.push('<td class="center"><input id="' + this.inputIdentity() + '" name="' + radioName + '" type="radio" value="Least" /></td>');
            html.push('<td class="center"><input id="' + this.inputIdentity() + '" name="' + radioName + '" type="radio" value="Medium" /></td>');
            html.push('<td class="center"><input id="' + this.inputIdentity() + '" name="' + radioName + '" type="radio" value="Most" /></td>');
            html.push('</tr>');
            html.push('<tr>');
            this.itemCount++;
        ...
        buildProHtml: function () {
            ...
            html.push('<legend><span groupfor="cols">Rating Scale</span> #{ratingScaleTip}</legend>');
            ...
            html.push('<div class="baserow">');
            html.push('<fieldset class="choices">');
            html.push('<legend><span groupfor="rows">Items to be Rated</span> #{beRatedTip}</legend>');
        ...
        getTips: function () {
            ...
            return $.extend(tipsData, {
                ratingScaleTip: {
                    title: 'Rating Scale',
                    message: 'Enter the rating scale names in the boxes below. These names will become the column headings for your scale.'
                },
                beRatedTip: {
                    title: 'Attribute Items',
                    message: 'Attribute items to be rated.'
                }
            });
        }
