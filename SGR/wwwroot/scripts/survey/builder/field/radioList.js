...
(function () {
    ...
    yardi.extend(radioList, yardi.baseField, {
        ...
        buildHtml: function () {
            ...
            yardi.baseSnippets.fieldCommon(html, this, 'Opci&oacute;n simple');
            html.push('<div class="group_">');
            this.indexKey++;
            html.push('<span class="item">');
            html.push('<input #{sync}="' + this.indexKey + '" name="#{n}" id="' + this.getInputId() + '" type="radio" value="Opci&oacute;n 1"/>');
            html.push('<label #{sync}="' + this.indexKey + '" for="' + this.getInputId() + '" empty="false" class="custext">Opci&oacute;n 1</label>&nbsp; &nbsp;');
            html.push('</span>');
            this.indexKey++;
            html.push('<span class="item">');
            html.push('<input #{sync}="' + this.indexKey + '" name="#{n}" id="' + this.getInputId() + '" type="radio" value="Opci&oacute;n 2"/>');
            html.push('<label #{sync}="' + this.indexKey + '" for="' + this.getInputId() + '" empty="false" class="custext">Opci&oacute;n 2</label>&nbsp; &nbsp;');
            html.push('</span>');
            this.indexKey++;
            html.push('<span class="item">');
            html.push('<input #{sync}="' + this.indexKey + '" name="#{n}" id="' + this.getInputId() + '"  type="radio" value="Opci&oacute;n 3"/>');
