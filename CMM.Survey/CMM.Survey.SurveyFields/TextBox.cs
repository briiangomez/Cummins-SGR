...
{
	public class TextBox : BaseQuestion
	{
		[System.Runtime.CompilerServices.CompilerGenerated]
		private static Func<SurveyAnswer, bool> wr6IGLmNk;
		
		public TextBox(HtmlNode node) : base (node)
		{
		}
		...
		{
			if (TextBox.wr6IGLmNk == null)
			{
				TextBox.wr6IGLmNk = new Func<SurveyAnswer, bool>(TextBox.inge7CRv4);
			}
			SurveyAnswer surveyAnswer = value.Where(TextBox.wr6IGLmNk).FirstOrDefault<SurveyAnswer>();
