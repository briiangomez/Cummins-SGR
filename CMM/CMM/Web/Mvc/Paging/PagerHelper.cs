namespace CMM.Web.Mvc.Paging
{
    ...
    public static class PagerHelper
    {
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, PagedList<T> pagedList, AjaxOptions ajaxOptions)
        {
            ...
            return html.AjaxPager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, null, null, ((RouteValueDictionary) null), ajaxOptions, ((IDictionary<string, object>) null));
        }
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, PagedList<T> pagedList, PagerOptions pagerOptions, AjaxOptions ajaxOptions)
        {
            ...
            return html.AjaxPager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, null, pagerOptions, ((RouteValueDictionary) null), ajaxOptions, ((IDictionary<string, object>) null));
        }
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, PagedList<T> pagedList, string routeName, AjaxOptions ajaxOptions)
        {
            ...
            return html.AjaxPager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, routeName, null, ((RouteValueDictionary) null), ajaxOptions, ((IDictionary<string, object>) null));
        }
        ...
        public static MvcHtmlString AjaxPager<T>(this HtmlHelper html, PagedList<T> pagedList, string actionName, string controllerName, PagerOptions pagerOptions, AjaxOptions ajaxOptions)
        {
            ...
            return html.AjaxPager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, actionName, controllerName, null, pagerOptions, ((RouteValueDictionary) null), ajaxOptions, ((IDictionary<string, object>) null));
        }
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, PagedList<T> pagedList)
        {
            ...
            return helper.Pager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, null, null, ((RouteValueDictionary) null), ((IDictionary<string, object>) null));
        }

        public static MvcHtmlString Pager<T>(this AjaxHelper ajax, PagedList<T> pagedList, AjaxOptions ajaxOptions)
        {
            return ((pagedList == null) ? Pager(ajax, null, null) : ajax.Pager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, null, null, ((RouteValueDictionary) null), ajaxOptions, ((IDictionary<string, object>) null)));
        }
        ...
        public static MvcHtmlString Pager<T>(this HtmlHelper helper, PagedList<T> pagedList, PagerOptions pagerOptions)
        {
            ...
            return helper.Pager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, pagerOptions, null, ((RouteValueDictionary) null), ((IDictionary<string, object>) null));
        }
        ...
        {
            return ((pagedList == null) ? Pager(ajax, pagerOptions, null) : ajax.Pager(pagedList.TotalPageCount, pagedList.CurrentPageIndex, null, null, null, pagerOptions, ((RouteValueDictionary) null), ajaxOptions, ((IDictionary<string, object>) null)));
        }
