...
(function ($) {
    ...
    baseField.register = function (key, type) {
        ...
        if (ts[key]) {
            alert('typeKey: ' + key + ' está vigente, no puede registrarlo.');
        } else {
            ts[key] = type;
        }
    };
    ...
    baseField.prototype = {
        ...
        buildHtml: function () {
            alert('buildHtml debe ser anulado por la subclase.');
        },

        buildProHtml: function () {
            alert('buildpro Html debe ser anulado por la subclase.');
        },
