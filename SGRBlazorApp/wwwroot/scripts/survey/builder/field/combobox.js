...
(function () {
    ...
    yardi.extend(comboBox, yardi.baseField, {
        ...
        buildHtml: function () {
            ...
            yardi.baseSnippets.fieldCommon(html, this, 'ComboBox');
            html.push('<div class="wrap">');
            html.push('<select id="#{n}" name="#{n}">');
            this.indexKey++;
            html.push('<option id="' + this.getInputId() + '" #{sync}="' + this.indexKey + '">option1</option>');
            this.indexKey++;
            html.push('<option id="' + this.getInputId() + '" #{sync}="' + this.indexKey + '">option2</option>');
            this.indexKey++;
            html.push('<option id="' + this.getInputId() + '" #{sync}="' + this.indexKey + '">option3</option>');
            html.push('</select>');
            html.push('</div>');
