...
namespace Sgi.Pages
{
    public partial class AddUserRoleComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            userrole = new Sgi.Models.SgiCore.UserRole(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Sgi.Models.SgiCore.UserRole args)
        {
            try
            {
                var sgiCoreCreateUserRoleResult = await SgiCore.CreateUserRole(userrole);
                DialogService.Close(userrole);
            }
            catch (System.Exception sgiCoreCreateUserRoleException)
            {
                    NotificationService.Notify(NotificationSeverity.Error, $"Error", $"Unable to create new UserRole!");
            }
        }
