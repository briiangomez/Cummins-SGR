...
namespace Sgi.Pages
{
    public partial class AddRolePermissionComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            rolepermission = new Sgi.Models.SgiCore.RolePermission(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Sgi.Models.SgiCore.RolePermission args)
        {
            try
            {
                var sgiCoreCreateRolePermissionResult = await SgiCore.CreateRolePermission(rolepermission);
                DialogService.Close(rolepermission);
            }
            catch (System.Exception sgiCoreCreateRolePermissionException)
            {
